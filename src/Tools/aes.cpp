...
#define ROUND2(a, b, c, d)                                                                                           \
  {                                                                                                                  \
    t4= (T0[(t0 >> 0) & 0xFF]) ^ (T1[(t1 >> 8) & 0xFF]) ^ (T2[(t2 >> 16) & 0xFF]) ^ (T3[(t3 >> 24) & 0xFF]) ^ RK[a]; \
    t5= (T0[(t1 >> 0) & 0xFF]) ^ (T1[(t2 >> 8) & 0xFF]) ^ (T2[(t3 >> 16) & 0xFF]) ^ (T3[(t0 >> 24) & 0xFF]) ^ RK[b]; \
    t6= (T0[(t2 >> 0) & 0xFF]) ^ (T1[(t3 >> 8) & 0xFF]) ^ (T2[(t0 >> 16) & 0xFF]) ^ (T3[(t1 >> 24) & 0xFF]) ^ RK[c]; \
    t7= (T0[(t3 >> 0) & 0xFF]) ^ (T1[(t0 >> 8) & 0xFF]) ^ (T2[(t1 >> 16) & 0xFF]) ^ (T3[(t2 >> 24) & 0xFF]) ^ RK[d]; \
                                                                                                                     \
    t0= t4;                                                                                                          \
    t1= t5;                                                                                                          \
    t2= t6;                                                                                                          \
...
#define ROUND3(a, b, c, d)                                                                                                                                               \
  {                                                                                                                                                                      \
    t4= (T4[(t0 >> 0) & 0xFF] & 0x000000FF) ^ (T4[(t1 >> 8) & 0xFF] & 0x0000FF00) ^ (T4[(t2 >> 16) & 0xFF] & 0x00FF0000) ^ (T4[(t3 >> 24) & 0xFF] & 0xFF000000) ^ RK[a]; \
    t5= (T4[(t1 >> 0) & 0xFF] & 0x000000FF) ^ (T4[(t2 >> 8) & 0xFF] & 0x0000FF00) ^ (T4[(t3 >> 16) & 0xFF] & 0x00FF0000) ^ (T4[(t0 >> 24) & 0xFF] & 0xFF000000) ^ RK[b]; \
    t6= (T4[(t2 >> 0) & 0xFF] & 0x000000FF) ^ (T4[(t3 >> 8) & 0xFF] & 0x0000FF00) ^ (T4[(t0 >> 16) & 0xFF] & 0x00FF0000) ^ (T4[(t1 >> 24) & 0xFF] & 0xFF000000) ^ RK[c]; \
    t7= (T4[(t3 >> 0) & 0xFF] & 0x000000FF) ^ (T4[(t0 >> 8) & 0xFF] & 0x0000FF00) ^ (T4[(t1 >> 16) & 0xFF] & 0x00FF0000) ^ (T4[(t2 >> 24) & 0xFF] & 0xFF000000) ^ RK[d]; \
  }
...
uint RC[]= {0x00000001, 0x00000002, 0x00000004, 0x00000008, 0x00000010,
