...
##
# @private
# p_1045 has a bug, so we created our own polynomial
...
p_1045 = [0.99999999999998151058451,      0.69314718056364205693851, 
...
def sqrt_simplified_fx(x):
    ...
    m_odd, m, w = FixedPt.norm_simplified_SQ(x.v, x.k)
