...
\warning{The memory you need to reserve here includes the memory
you use in $\mathsf{Array}$ types which are stored in memory.
If you need to increase the amount of user memory, the compiler will
crash and let you know this.
At some point we aim to make this go-away in an easier manner.}

The \verb|KAPPA| parameter specifies the global statistical security 
