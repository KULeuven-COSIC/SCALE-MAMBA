...
\newcommand{\nps}[1]{{\textcolor{red}{\sf (NPS:) {\sl{#1}}}}}
\newcommand{\warning}[1]{{\textcolor{red}{\sf Warning: {\sl{#1}}}}}
\newcommand{\comm}[1]{{\textcolor{red}{\sl{#1}}}}
...
\newcommand{\ints}{\mathbf{i64}}
\newcommand{\bool}{\mathbf{bool}}
\newcommand{\SecretI}{\mathbf{SecretI64}}
\newcommand{\ClearModp}{\mathbf{ClearModp}}
\newcommand{\SecretModp}{\mathbf{SecretModp}}
\newcommand{\SecretBit}{\mathbf{SecretBit}}
\newcommand{\regint}{\mathsf{regint}}
\newcommand{\sregint}{\mathsf{sregint}}
\newcommand{\cint}{\mathsf{cint}}
\newcommand{\sint}{\mathsf{sint}}
\newcommand{\sbit}{\mathsf{sbit}}
