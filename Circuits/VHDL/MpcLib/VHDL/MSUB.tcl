...
analyze -format vhdl MSUB.vhd

elaborate MSUB -architecture behavioral -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -o MSUB$WordSize.v
