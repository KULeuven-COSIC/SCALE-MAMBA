...
analyze -format vhdl MNegate.vhd

elaborate MNegate -architecture behavioral -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -o MNegate$WordSize.v
