...
analyze -format vhdl MADD.vhd

elaborate MADD -architecture behavioral -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -o MADD$WordSize.v
