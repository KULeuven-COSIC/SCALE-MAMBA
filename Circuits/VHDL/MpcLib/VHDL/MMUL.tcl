...
analyze -format vhdl MMUL.vhd

elaborate MMUL -architecture structural -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -o MMUL$WordSize.v
