...
analyze -format vhdl MZeroEqual.vhd

elaborate MZeroEqual -architecture behavioral -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -o MZeroEqual$WordSize.v
