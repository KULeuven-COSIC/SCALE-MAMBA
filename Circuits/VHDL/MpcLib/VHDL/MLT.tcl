...
analyze -format vhdl MLT.vhd

elaborate MLT -architecture behavioral -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -o MLT$WordSize.v
