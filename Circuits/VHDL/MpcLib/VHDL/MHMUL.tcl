...
analyze -format vhdl MHMUL.vhd

elaborate MHMUL -architecture structural -library WORK -parameters "gWordSize=>$WordSize"
...
write -format verilog -hierarchy -o MHMUL$WordSize.v
