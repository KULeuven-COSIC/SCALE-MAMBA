...
analyze -format vhdl ../src/sha512pkg.vhd
analyze -format vhdl ../src/MADD64.vhd
...
analyze -format vhdl ../src/sha512.vhd

# compile the adder first
elaborate MADD64 -library WORK
check_design
link
uniquify
...
write -format verilog -hierarchy -o MADD64.v
remove_design

# now the whole circuit
analyze -format verilog MADD64.v
elaborate sha512 -library WORK
check_design
link
uniquify
set_ideal_network [all_inputs]
...
change_names -hierarchy -rules verilog
ungroup -all -flatten -simple_names
write -format verilog -hierarchy -o sha512.net
exit
